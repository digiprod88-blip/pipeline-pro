...
import { Store, CreditCard, IndianRupee, DollarSign, Upload, Check, AlertCircle } from "lucide-react";
...
export function ShopSettings() {
  ...
  const isRazorpayConfigured = !!form.razorpay_key_id;
  const isStripeConfigured = !!form.stripe_publishable_key;
        ...
        <Tabs defaultValue="branding" className="space-y-4">
          ...
          <TabsContent value="branding" className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              {form.logo_url && (
                <img src={form.logo_url} alt="Logo preview" className="h-16 w-16 object-contain rounded border" />
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              {form.banner_url && (
                <img src={form.banner_url} alt="Banner preview" className="h-24 w-full object-cover rounded border" />
              )}
            </div>
          </TabsContent>
            ...
            <Card className="border-dashed">
              ...
              <CardContent className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  Get your keys from{" "}
                  <a href="https://dashboard.razorpay.com/app/keys" target="_blank" rel="noreferrer" className="text-primary underline">
                    Razorpay Dashboard
                  </a>
                </p>
              </CardContent>
          ...
          <TabsContent value="legal" className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Enter your shop terms and conditions..."
                rows={6}
              />
            </div>
          </TabsContent>
